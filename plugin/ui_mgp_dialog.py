...
class Ui_MGPDialog(object):
    def setupUi(self, MGPDialog):
        ...
        MGPDialog.resize(509, 590)
        self.verticalLayoutWidget = QtWidgets.QWidget(MGPDialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 130, 481, 361))
        ...
        self.groupBoxDisplacer.setGeometry(QtCore.QRect(10, 10, 451, 301))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(0, 23, 441, 261))
        ...
        self.groupBoxCentroid_2.setGeometry(QtCore.QRect(10, 10, 451, 311))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 20, 451, 281))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 530, 486, 51))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 500, 481, 24))
