...
class Ui_MGPDialog(object):
    def setupUi(self, MGPDialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 0, 491, 621))
        ...
        self.horizontalLayoutRL_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayoutRL_5.setSizeConstraint(QtWidgets.QLayout.SetNoConstraint)
        self.horizontalLayoutRL_5.setContentsMargins(0, 0, -1, -1)
        self.horizontalLayoutRL_5.setObjectName("horizontalLayoutRL_5")
        self.yesnoLayerLabel = QtWidgets.QLabel(self.verticalLayoutWidget_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.yesnoLayerLabel.sizePolicy().hasHeightForWidth())
        self.yesnoLayerLabel.setSizePolicy(sizePolicy)
        self.yesnoLayerLabel.setObjectName("yesnoLayerLabel")
        self.horizontalLayoutRL_5.addWidget(self.yesnoLayerLabel)
        self.yesnoLayerLineEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget_6)
        self.yesnoLayerLineEdit.setObjectName("yesnoLayerLineEdit")
        self.horizontalLayoutRL_5.addWidget(self.yesnoLayerLineEdit)
        self.yesnoLayerToolButton = QtWidgets.QToolButton(self.verticalLayoutWidget_6)
        self.yesnoLayerToolButton.setObjectName("yesnoLayerToolButton")
        self.horizontalLayoutRL_5.addWidget(self.yesnoLayerToolButton)
        self.verticalLayout_6.addLayout(self.horizontalLayoutRL_5)
        ...
        self.labelLogo.setGeometry(QtCore.QRect(310, 9, 177, 35))
    ...
    def retranslateUi(self, MGPDialog):
        ...
        self.yesnoLayerLabel.setText(_translate("MGPDialog", "Yes / No Layer (optional) "))
        self.yesnoLayerToolButton.setText(_translate("MGPDialog", "..."))
