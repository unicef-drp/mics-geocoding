...
class Ui_MicsGeocodePluginDialog(object):
    ...
    def retranslateUi(self, MicsGeocodePluginDialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_step1), _translate("MicsGeocodePluginDialog", "Step 1 - Load"))
        self.groupBoxDisplacer.setTitle(_translate("MicsGeocodePluginDialog", "Centroid Displacement"))
        self.loadCentroidsFromStep01.setText(_translate("MicsGeocodePluginDialog", "Load centroids from Step 1"))
        self.centroidsLayerLabel.setText(_translate("MicsGeocodePluginDialog", "Centroids"))
        self.centroidsLayerToolButton.setText(_translate("MicsGeocodePluginDialog", "..."))
        self.centroidsLayerTypeFieldLabel.setText(_translate("MicsGeocodePluginDialog", "Type Field"))
        self.centroidsLayerNumeroFieldLabel.setText(_translate("MicsGeocodePluginDialog", "Numero Field"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_step2), _translate("MicsGeocodePluginDialog", "Step 2 - Displace"))
        ...
        self.loadCovrefFromStep01.setText(_translate("MicsGeocodePluginDialog", "Load reference from Step 2"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_step3), _translate("MicsGeocodePluginDialog", "Step 3 - Extract"))
