...
class Ui_MicsGeocodePluginDialog(object):
    def setupUi(self, MicsGeocodePluginDialog):
        ...
        MicsGeocodePluginDialog.resize(624, 654)
        self.verticalLayoutWidget = QtWidgets.QWidget(MicsGeocodePluginDialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 604, 581))
        ...
        self.basenameLineEdit.setGeometry(QtCore.QRect(10, 10, 579, 31))
        self.basenameLineEdit.setObjectName("basenameLineEdit")
        self.layoutWidget = QtWidgets.QWidget(self.tab_step1)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 50, 579, 41))
        ...
        self.groupBoxCentroid.setGeometry(QtCore.QRect(10, 100, 579, 241))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 20, 571, 211))
        ...
        self.layoutWidget1 = QtWidgets.QWidget(self.pageAuto)
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 0, 551, 121))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.formLayout = QtWidgets.QFormLayout(self.layoutWidget1)
        self.formLayout.setContentsMargins(0, 0, 0, 0)
        self.formLayout.setObjectName("formLayout")
        self.typeFieldLabel_3 = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.typeFieldLineEdit = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.numeroFieldLabel = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.numeroFieldLineEdit = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.longitudeFieldLabel_3 = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.longitudeFieldLineEdit = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.latitudeFieldLabel_3 = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.latitudeFieldLineEdit = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.layoutWidget2 = QtWidgets.QWidget(self.pageManual)
        self.layoutWidget2.setGeometry(QtCore.QRect(0, 0, 551, 141))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.formLayout_3 = QtWidgets.QFormLayout(self.layoutWidget2)
        self.formLayout_3.setContentsMargins(0, 0, 0, 0)
        self.formLayout_3.setObjectName("formLayout_3")
        self.typeFieldLabel_2 = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.typeFieldComboBox = QtWidgets.QComboBox(self.layoutWidget2)
        ...
        self.numeroFieldLabel_2 = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.numeroFieldComboBox = QtWidgets.QComboBox(self.layoutWidget2)
        ...
        self.longitudeFieldLabel_2 = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.longitudeFieldComboBox = QtWidgets.QComboBox(self.layoutWidget2)
        ...
        self.latitudeFieldLabel_2 = QtWidgets.QLabel(self.layoutWidget2)
        ...
        self.latitudeFieldComboBox = QtWidgets.QComboBox(self.layoutWidget2)
        ...
        self.groupBoxDisplacer.setGeometry(QtCore.QRect(10, 340, 579, 191))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(0, 23, 571, 161))
        ...
        self.layoutWidget3 = QtWidgets.QWidget(MicsGeocodePluginDialog)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 600, 291, 51))
        self.layoutWidget3.setObjectName("layoutWidget3")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget3)
        self.horizontalLayout_2.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.loadConfigButton = QtWidgets.QPushButton(self.layoutWidget3)
        ...
        self.saveConfigButton = QtWidgets.QPushButton(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.saveConfigAsButton = QtWidgets.QPushButton(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelLogo = QtWidgets.QLabel(MicsGeocodePluginDialog)
        self.labelLogo.setGeometry(QtCore.QRect(339, 605, 259, 35))
        ...
        self.labelLogo.setMinimumSize(QtCore.QSize(259, 35))
        self.labelLogo.setText("")
        self.labelLogo.setPixmap(QtGui.QPixmap("C:\\Users\\Etienne\\Documents\\devel\\mics-geocode-unicef-plugin\\plugin\\logo_nobg.png"))
