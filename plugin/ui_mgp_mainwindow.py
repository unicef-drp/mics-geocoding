...
class Ui_MGPDialog(object):
    def setupUi(self, MGPDialog):
        ...
        self.verticalLayout_3.addWidget(self.generateCentroidBuffersButton)
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(0, 23, 461, 221))
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 20, 461, 41))
