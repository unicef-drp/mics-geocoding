...
set PLUGIN_FILES=%PLUGIN_FILES%;mgp_main_window_tab1handlery.py
set PLUGIN_FILES=%PLUGIN_FILES%;mgp_main_window_tab2handlery.py
set PLUGIN_FILES=%PLUGIN_FILES%;mgp_main_window_tab3handlery.py
