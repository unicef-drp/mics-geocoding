...
set PLUGIN_FILES=%PLUGIN_FILES%;mics_geocode_plugin_main_window_tab2handlery.py
set PLUGIN_FILES=%PLUGIN_FILES%;mics_geocode_plugin_main_window_tab3handlery.py
